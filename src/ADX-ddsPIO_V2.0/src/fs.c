...
static bool __attribute__((unused))copy_json_string(const char* p, char* out, size_t out_max, size_t* adv);
...
//static char* rtrim(char* s) __attribute__((unused));
...
static char* ltrim(char* s) __attribute__((unused));
